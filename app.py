...
def init_db():
    ...
    # Add year column if old database doesn't have it
    cur.execute("""
    ...
    # Make sure user + year + month is unique
    cur.execute("""
        DO $$
        BEGIN
            IF NOT EXISTS (
...
TEXTS = {
    ...
    "English": {
        ...
        "delete": "Delete",
        "action": "Action",
        "delete_confirm": "Are you sure you want to delete this month?"
    },
    ...
    "Telugu": {
        ...
        "delete": "డిలీట్",
        "action": "చర్య",
        "delete_confirm": "ఈ నెలను డిలీట్ చేయాలా?"
    },
    ...
    "Hindi": {
        ...
        "delete": "डिलीट",
        "action": "कार्यवाही",
        "delete_confirm": "क्या आप इस महीने को डिलीट करना चाहते हैं?"
    }
}
...
def dashboard():
    ...
    <div class="container">
        ...
        <div class="card center">
            ...
            <a href="{{ url_for('language', lang='English') }}">
                English
            </a>
            |
            <a href="{{ url_for('language', lang='Telugu') }}">
                తెలుగు
            </a>
            |
            <a href="{{ url_for('language', lang='Hindi') }}">
                हिन्दी
            </a>
...
def expenses():
    ...
    if request.method == "POST":
        ...
        # Same user + same year + same month
...
def delete_expense(expense_id):
    ...
    # First get the year.
    # This is also restricted to the logged-in user.
    cur.execute("""
        SELECT year
        FROM expenses
        WHERE id=%s
